 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://inventory.service.hw4.ws.uciext.com", wsdlLocation = "http://localhost:8080/inventoryWS/ws/OrderServiceHw4?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://inventory.service.hw4.ws.uciext.com", "OrderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/inventoryWS/ws/OrderServiceHw4?wsdl");
    ...
    public OrderServiceWS getOrderPort() {
        return super.getPort(new QName("http://inventory.service.hw4.ws.uciext.com", "OrderPort"), OrderServiceWS.class);
    }
     ...
     */
    @WebEndpoint(name = "OrderPort")
    public OrderServiceWS getOrderPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://inventory.service.hw4.ws.uciext.com", "OrderPort"), OrderServiceWS.class, features);
    }
